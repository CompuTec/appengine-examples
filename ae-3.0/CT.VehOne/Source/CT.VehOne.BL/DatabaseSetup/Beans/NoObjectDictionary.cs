...
{
    [Install]
    public class NoObjeectDictionary : UDOManager
    {
        public const String OBJECT_CODE = "CT_CS_Dic";
        public const String HEADER_TABLE_NAME = "CT_CS_ODIC";
        public const String HEADER_TABLE_DESCRIPTION = "SimDictionary";
        public const string ARCHIVE_TABLE_NAME = "CT_CS_ADIC";

        public NoObjeectDictionary(ICoreConnection connection, IDatabaseSetupManager manager) : base(connection,
            manager)
        {
        }
        ...
        protected override IUDOTable CreateUDOTable()
        {
            ...
            IUDOTable UdoTable = new UDOTable(fields, findColumns, HEADER_TABLE_NAME, HEADER_TABLE_DESCRIPTION,
                BoUTBTableType.bott_NoObject, CreateKeys());
