...
public class MasterDataHead : UDOManager
{
    ...
    protected override IUDOTable CreateUDOTable()
    {
        ...
        // authorizationList.Add(new DocumentAuthorizationInfo("CT_PF_OBOM", "Bill of Materials",
        //     "DocumentHead", BoUPTOptions.bou_FullReadNone, 4, "CT_CS_OBOMCode"));
        // authorizationList.Add(new DocumentAuthorizationInfo("CT_PF_OBOMT", "Bill of Materials Technology",
        //     "DocumentHead", BoUPTOptions.bou_FullReadNone, 4, "CT_CS_OBOMTech"));
        List<IUDOField> fields = CreateFieldsForHeaderTable();
        List<IUDOFindColumn> findColumns = CreateFindColumnsList();
        List<IUDOTableKey> keys = CreateKeys();
        IUDOTable UdoTable = new UDOTable(fields, findColumns, HEADER_TABLE_NAME, HEADER_TABLE_DESCRIPTION,
            BoUTBTableType.bott_MasterData, keys);
        ...
        UdoTable.Authorizations =
            new AuthorizationUDO(VehicleOneAuthorization.VO_OBJECTS_ID, VehicleOneAuthorization.VO_OBJECS_NAme,
                BoUPTOptions.bou_FullReadNone, authorizationList);
        UdoTable.ArchiveTableName = "CT_VO_AMDA";
        return UdoTable;
    }
    ...
    private List<IUDOFindColumn> CreateFindColumnsList()
    {
        ...
        IUDOFindColumn codeColumn = new UDOFindColumn();
        codeColumn.SetColumnAlias("Code");
        codeColumn.SetColumnDescription("Code");
        findColumns.Add(codeColumn);
